...
class EditOrderModalContent extends StatefulWidget {
  static final GlobalKey<_EditOrderModalContentState> globalKey = GlobalKey();
  String orderCode;
  String desc;
  ...
  @override
  State<EditOrderModalContent> createState() => _EditOrderModalContentState();
}

class _EditOrderModalContentState extends State<EditOrderModalContent> {
  //List
  ...
  void initState() {
    ...
    requestedDeliveryDate = DateTime.parse(widget.requestedDeliveryDate);
